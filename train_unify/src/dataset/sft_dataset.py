...
def make_supervised_data_module(model_id, processor, data_args):
    ...
    if data_args.eval_path is not None:
        eval_data_path = data_args.eval_path
        if data_args.eval_max_samples is not None and data_args.eval_max_samples > 0:
            eval_data_path = json.load(open(data_args.eval_path, "r"))[: data_args.eval_max_samples]
